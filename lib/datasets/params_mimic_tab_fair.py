...
all_cols = ['1_Diastolic blood pressure mean', '2_Diastolic blood pressure mean',
...
# select 10 features such that group information cannot be predicted from it
train_cols=['1_Fraction inspired oxygen mean', '2_Fraction inspired oxygen mean',
       '2_Glascow coma scale total mean', '3_Glucose mean', '4_Glucose mean',
       '4_Heart Rate mean', '3_Respiratory rate mean',
       '4_Respiratory rate mean', '4_Systolic blood pressure mean',
       '3_Temperature mean']
...
columns = all_cols + [label] + sensitive_attributes + ['fold_id', 'ID']
