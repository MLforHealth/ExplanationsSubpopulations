...
class LimeTabularExplainer(object):
    ...
    def explain_instance(self,
        ...
        Args:
            ...
            grp_clf: sklearn classifier that predicts the protected group
        ...
        data, inverse = self.__data_inverse(data_row, num_samples, sampling_method, perturb_sigma = perturb_sigma)
    ...
    def __data_inverse(self,
        ...
        if self.discretizer is None:
            ...
            if sampling_method == 'gaussian':
                data = self.random_state.normal(0, perturb_sigma, num_samples * num_cols
